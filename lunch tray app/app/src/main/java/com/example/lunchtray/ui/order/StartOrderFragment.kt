...
import com.example.lunchtray.R.id.action_startOrderFragment_to_entreeMenuFragment
...
class StartOrderFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.startOrderBtn.setOnClickListener {
            ...
            val action = StartOrderFragmentDirections.actionStartOrderFragmentToEntreeMenuFragment2()
