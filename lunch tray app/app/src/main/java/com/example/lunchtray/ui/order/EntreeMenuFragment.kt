...
import com.example.lunchtray.R.id.action_entreeMenuFragment_to_sideMenuFragment
import com.example.lunchtray.R.id.action_entreeMenuFragment_to_startOrderFragment
...
class EntreeMenuFragment : Fragment() {
    ...
    fun cancelOrder() {
        ...
        val action = EntreeMenuFragmentDirections.actionEntreeMenuFragmentToStartOrderFragment2()
        this.findNavController().navigate(action)
    }
