...
import com.example.lunchtray.R.id.action_checkoutFragment_to_startOrderFragment
...
class CheckoutFragment : Fragment() {
    ...
    fun cancelOrder() {
        ...
        val action = CheckoutFragmentDirections.actionCheckoutFragmentToStartOrderFragment2()
