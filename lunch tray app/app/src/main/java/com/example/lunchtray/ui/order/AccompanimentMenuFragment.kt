...
import com.example.lunchtray.R.id.action_accompanimentMenuFragment_to_checkoutFragment
import com.example.lunchtray.R.id.action_accompanimentMenuFragment_to_startOrderFragment
...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        val action = AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToCheckoutFragment2()
    ...
    fun cancelOrder() {
        ...
        val action = AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToStartOrderFragment2()
        this.findNavController().navigate(action)
    }
