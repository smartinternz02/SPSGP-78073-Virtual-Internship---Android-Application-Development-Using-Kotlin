...
import com.example.lunchtray.R.id.action_sideMenuFragment_to_startOrderFragment
...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        val action = SideMenuFragmentDirections.actionSideMenuFragmentToAccompanimentMenuFragment2()
    ...
    fun cancelOrder() {
        ...
        val action = SideMenuFragmentDirections.actionSideMenuFragmentToStartOrderFragment2()
        this.findNavController().navigate(action)
    }
